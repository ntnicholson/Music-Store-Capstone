...
<br/>
	...
	<div class="row">
	<h2 style="color:white;"><i class="material-icons" id="warning"> warning_amber </i> Delete:"${category.name}"</h2><br/>
	</div>
	</div>
	<div class="d-flex flex-row justify-content-center align-items-center container">
	<div class="form-control">
		<form method="post">
			...
			<div class="btn"><a href="/admin/category/manage"><button type="button" class="btn btn-success">Cancel</button></a></div>
		</div>
		</form>
	</div>
	</div>
